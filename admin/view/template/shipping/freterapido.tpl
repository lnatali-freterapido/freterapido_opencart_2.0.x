        ...
        <div>
          <div style="padding:15px;text-align: center; vertical-align:bottom;">
            ...
            <div style="padding-top: 20px;">
              ...
              Em caso de dúvidas, reporte de bugs ou sugestão de melhorias, acesse a <a href="https://github.com/freterapido/freterapido_opencart_2.0.x" target="_blank"<name />documentação deste módulo no Github</a>.
              </br>
            </div>
          </div>
        </div>
